                ...
                <div class="panel-body">
                    <form id="productform" class="form-horizontal" role="form" method="POST"
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Product Name: <span
                                    class="required-mark" style="color:red"> *</span></label></label>
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            <label for="description" class="col-md-4 control-label">Product Description: <span
                                    class="required-mark" style="color:red"> *</span></label>
                            <div class="col-md-6">
                                <textarea class="form-control" rows="8" cols="70" id="description" name="description" required>{{ old('description') }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                            <label for="price" class="col-md-4 control-label">Price:<span class="required-mark"
                                    style="color:red"> *</span></label>

                            <div class="col-md-6">
                                <input id="price" type="number" min="1" class="form-control" name="price"
                                    value="{{ old('price') }}" placeholder=" Range i.e : 5">
                        ...
                        <div class="form-group{{ $errors->has('stockquantity') ? ' has-error' : '' }}">
                            <label for="stockquantity" class="col-md-4 control-label">Quantity:<span
                                    class="required-mark" style="color:red"> *</span></label>

                            <div class="col-md-6">
                                <input id="stockquantity" type="stockquantity" min="1" class="form-control"
                                    name="stockquantity" value="{{ old('stockquantity') }}"
